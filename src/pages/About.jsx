  ...
  return (
    <div className='bg-emerald-300'>
        ...
        <p className="text-center mt-4 text-xl text-fuchsia-700">
            ...
            functional web applications.<span className='font-bold'> My journey in web development started with
            a curiosity to understand how websites work, and it has evolved into a
            full-fledged career.</span>
        </p>
        <p className="text-center mt-4 text-xl text-indigo-700">
            ...
            eager to learn new skills and improve my craft. <span className='font-bold'>In my free time, I love
            to explore new places, read books, and contribute to open-source
            projects.</span>
        </p>
    </div>
  )
